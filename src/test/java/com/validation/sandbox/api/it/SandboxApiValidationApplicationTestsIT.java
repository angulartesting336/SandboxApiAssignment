package com.validation.sandbox.api.it;
...
public class SandboxApiValidationApplicationTestsIT {
	...
	public void paymentValidationInvalidCertificateTest() throws Exception {
		...
		headers.set("Signature",
				"");
	//	headers.add("SignatureCertificate", unknownCertificate);
		System.out.println(unknownCertificate);
		headers.set("SignatureCertificate",
				unknownCertificate);
		headers.set("XRequestId", "29318e25-cebd-498c-888a-f77672f66449");
